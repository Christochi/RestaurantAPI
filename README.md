...
Resize the image and create 2 copies. One copy of dimension ***890 x 593*** and name it ***image-name-large (chicken-fried-rice-large)***, and the other of dimension ***500 x 333*** also named as ***chicken-fried-rice-small***
